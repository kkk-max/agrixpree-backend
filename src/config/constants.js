...
// Shop delivery: free at/above the threshold, flat fee below it.
const FREE_DELIVERY_THRESHOLD = 200;
const DELIVERY_FEE = 20;

// Packing & Handling: charged on every order, as a % of the vegetable order value.
const HANDLING_CHARGE_PERCENT = 2;

module.exports = { ROLES, KYC_STATUS, PRODUCT_STATUS, ORDER_STATUS, PAYMENT_STATUS, OTP_TTL_MINUTES, OTP_MAX_PER_HOUR, BCRYPT_ROUNDS, MAX_PRODUCT_IMAGES, FREE_DELIVERY_THRESHOLD, DELIVERY_FEE, HANDLING_CHARGE_PERCENT };
